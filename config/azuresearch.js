		...
		if (response.statusCode == 404){
			...
			options.body ={ 
			  ...
			  "fields": [
			    ...
			    {"name": "locationAddress", "type": "Edm.String","filterable": false,"facetable": false, "suggestions": true}, 
			    ...
			    {"name": "descriptionService", "type": "Edm.String","filterable": false,"facetable": false, "suggestions": true}, 
			    {"name": "primaryBusinessSector", "type": "Edm.String", "suggestions": true}, 

			    {"name": "descriptionCause", "type": "Edm.String","filterable": false,"facetable": false, "suggestions": true}, 

			    {"name": "socialPurposeCategory", "type": "Edm.String", "suggestions": true}, 
			    {"name": "organizationalStructure", "type": "Edm.String", "suggestions": true}, 
